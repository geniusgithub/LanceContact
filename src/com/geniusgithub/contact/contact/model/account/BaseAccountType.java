...
package com.geniusgithub.contact.contact.model.account;
...
import com.geniusgithub.contact.common.util.ContactDisplayUtils;
...
public abstract class BaseAccountType extends AccountType {
    ...
    public BaseAccountType() {
        ...
        this.iconRes = R.drawable.ic_contacts_clr_48cv_44dp;
    }
    ...
    protected DataKind addDataKindDisplayName(Context context) throws DefinitionException {
        ...
        boolean displayOrderPrimary = true;
    ...
    private static class NameKindBuilder extends KindBuilder {
        ...
        public List<DataKind> parseDataKind(Context context, XmlPullParser parser,
            ...
            final boolean displayOrderPrimary = true;
           //   ignore       context.getResources().getBoolean(R.bool.config_editor_field_order_primary);

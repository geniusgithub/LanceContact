...
import com.geniusgithub.contact.contact.model.AccountTypeManager;
import com.geniusgithub.contact.contact.model.account.AccountWithDataSet;
import com.geniusgithub.contact.contact.model.account.dataitem.ImDataItem;
...
public class ContactsUtils {
    ...
    public static Pair<Intent, Intent> buildImIntent(Context context, ImDataItem im) {
        ...
        if (!isEmail && !im.isProtocolValid()) {
            return new Pair<Intent, Intent>(null, null);
        }
        ...
        return new Pair<Intent, Intent>(intent, secondaryIntent);
    }
}

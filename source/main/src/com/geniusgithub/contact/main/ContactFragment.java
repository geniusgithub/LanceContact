...
public class ContactFragment extends BaseFragment{
	...
	private static final CommonLog log = LogFactory.createLog(ContactFragment.class.getSimpleName());
   ...
   public ContactFragment(Context context) {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mFragmentContainer = (ViewGroup) LayoutInflater.from(mContext).inflate(R.layout.contact_fragment, container, false); 
